...
**禁止**用 `Modal.confirm` 做内联删除。
Popconfirm 更轻量，删除是高频小操作，不需要弹窗阻断。

## Tooltip

Tooltip **仅**用于纯图标按钮提供可访问标签：
```tsx
<Tooltip title="编辑">
...
不要使用 Drawer 或 Popover 做提示。Tooltip 是最轻量的辅助信息层，
