...
export const remainingAmount = (bill: MonthlyBill) => Number(bill.totalAmount) - Number(bill.paidAmount);
...
export const getPaymentAmountError = (amountText: string, remaining: number) => {
