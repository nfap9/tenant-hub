    ...
    <>
      ...
      <ScrollView className="rooms-list" scrollY>
        ...
        {visibleRooms.map((room) => {
          ...
          const roomActiveLease = room.leases?.find(
            (item) => item.status === 'ACTIVE'
          );
          return (
            <View
              key={room.id}
              className={`room-card ${expanded ? 'room-card--active' : ''}`}
                    ...
                    {canManageRoom ? (
                      <View onClick={(e) => e.stopPropagation()}>
                        <Button
                          ...
                          onClick={() =>
                            Taro.navigateTo({
                              url: `/pages/rooms/room-form?roomId=${room.id}`,
                            })
                          }
                        >
                          编辑房间
                        ...
                        <View className="action-row-inline">
                          <View onClick={(e) => e.stopPropagation()}>
                            <Button
                              ...
                              onClick={() =>
                                Taro.navigateTo({
                                  url: `/pages/rooms/lease-edit?roomId=${room.id}`,
                                })
                              }
                            >
                              编辑租约
                          ...
                          <View onClick={(e) => e.stopPropagation()}>
                            <Button
                              ...
                              onClick={() =>
                                Taro.navigateTo({
                                  url: `/pages/rooms/lease-terminate?roomId=${room.id}`,
                                })
                              }
                            >
                              退租
