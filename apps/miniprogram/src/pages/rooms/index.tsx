...
export default function RoomsPage() {
  ...
  const [filter, setFilter] = useState<"ALL" | "VACANT" | "OCCUPIED" | "RESERVED" | "MAINTENANCE">("ALL");
  ...
  const handleFilterChange = (nextFilter: "ALL" | "VACANT" | "OCCUPIED" | "RESERVED" | "MAINTENANCE") => {
