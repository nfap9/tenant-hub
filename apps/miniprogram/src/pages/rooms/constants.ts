import type { RoomStatus, RentCycle, BillItemType, TerminationType } from '../../types/domain';
...
export const filters: Array<RoomStatus | "ALL"> = ["ALL", "VACANT", "OCCUPIED", "RESERVED", "MAINTENANCE"];

export const roomStatuses: RoomStatus[] = ["VACANT", "RESERVED", "OCCUPIED", "MAINTENANCE"];

export const cycleLabels: Record<RentCycle, string> = { MONTHLY: "月付", QUARTERLY: "季付", YEARLY: "年付" };
...
export const terminationLabels: Record<TerminationType, string> = { EXPIRED: "到期解约", NEGOTIATED: "协商解约", BREACH: "违约退租" };

export type LeaseFeeFormItem = { id: string; type: BillItemType; name: string; amount: string };

export const emptyRoomForm = { roomNo: "", layout: "", area: "", facilities: "", status: "VACANT" as RoomStatus };
...
export const emptyEditLeaseForm = { rentAmount: "", depositAmount: "", waterUnitPrice: "0", powerUnitPrice: "0" };
