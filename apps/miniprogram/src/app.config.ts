export default defineAppConfig({
  pages: [
    'pages/index/index',
    'pages/rooms/index',
    'pages/rooms/room-form',
    'pages/rooms/lease-form',
    'pages/rooms/lease-edit',
    'pages/rooms/lease-terminate',
    'pages/bills/index',
    'pages/bills/payment',
    'pages/bills/reading',
    'pages/bills/utility',
    'pages/bills/utility-import',
    'pages/bills/utility-export',
    'pages/bills/monthly-detail',
    'pages/bills/edit-item',
