...
export default function LoginScreen({
    ...
    try {
      ...
      const body = isRegister
        ...
        : mode === 'password'
          ? { phone, password }
          : { phone, code };
      const result = await mobileApi<MobileSession>(path, undefined, {
        method: 'POST',
  ...
  return (
    <SafeAreaView style={styles.loginShell}>
      ...
      >
        <ScrollView
          contentContainerStyle={[styles.loginContent, isRegister && styles.loginContentCompact]}
            ...
            {!isRegister ? (
              <View style={styles.segment}>
                <View style={[styles.segmentItem, mode === 'code' && styles.segmentItemActive]}>
                  <Text
                    style={[styles.segmentText, mode === 'code' && styles.segmentTextActive]}
                ...
                <View style={[styles.segmentItem, mode === 'password' && styles.segmentItemActive]}>
                  <Text
                    style={[styles.segmentText, mode === 'password' && styles.segmentTextActive]}
