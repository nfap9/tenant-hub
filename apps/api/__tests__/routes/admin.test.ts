...
describe("admin routes", () => {
  ...
  describe("GET /api/admin/users", () => {
    it("should return users list", async () => {
      (prisma.user.findMany as ReturnType<typeof vi.fn>).mockResolvedValue([
        { id: "user-1", phone: "13800138000", username: "测试用户", platformRole: "SUPER_ADMIN", createdAt: new Date(), _count: { memberships: 1 } }
      ]);
  ...
  describe("GET /api/admin/summary", () => {
    it("should return platform summary", async () => {
      ...
      (prisma.apartment.count as ReturnType<typeof vi.fn>).mockResolvedValue(20);
      ...
      expect(res.status).toBe(200);
      expect(res.body.data).toMatchObject({ organizations: 5, users: 10, apartments: 20, rooms: 100, activeLeases: 80, unpaidBills: 30 });
    });
  });

  describe("GET /api/admin/plans", () => {
    it("should return plans", async () => {
      (prisma.plan.findMany as ReturnType<typeof vi.fn>).mockResolvedValue([{ id: "plan-1", name: "基础版" }]);
  ...
  describe("POST /api/admin/plans", () => {
    it("should create a plan", async () => {
      (prisma.plan.create as ReturnType<typeof vi.fn>).mockResolvedValue({ id: "plan-1", name: "基础版" });

      const res = await request(app)
        .post("/api/admin/plans")
        .set("Authorization", `Bearer ${authToken}`)
        .send({ name: "基础版", apartmentLimit: 1, roomLimit: 10, memberLimit: 5, price: 99 });
  ...
  describe("PUT /api/admin/plans/:id", () => {
    it("should update a plan", async () => {
      (prisma.plan.update as ReturnType<typeof vi.fn>).mockResolvedValue({ id: "plan-1", name: "高级版" });
  ...
  describe("GET /api/admin/organizations", () => {
    it("should return organizations", async () => {
      (prisma.organization.findMany as ReturnType<typeof vi.fn>).mockResolvedValue([{ id: "org-1", name: "测试组织" }]);
  ...
  describe("PUT /api/admin/organizations/:id/status", () => {
    it("should update organization status", async () => {
      (prisma.organization.update as ReturnType<typeof vi.fn>).mockResolvedValue({ id: "org-1", status: "SUSPENDED" });
  ...
  describe("POST /api/admin/organizations/:id/quota-packages", () => {
    it("should create quota package", async () => {
      (prisma.orgQuotaPackage.create as ReturnType<typeof vi.fn>).mockResolvedValue({ id: "qp-1" });
  ...
  describe("GET /api/admin/roles", () => {
    it("should return roles", async () => {
      (prisma.role.findMany as ReturnType<typeof vi.fn>).mockResolvedValue([{ id: "role-1", code: "owner" }]);
  ...
  describe("POST /api/admin/roles", () => {
    it("should create a custom role", async () => {
      (prisma.role.create as ReturnType<typeof vi.fn>).mockResolvedValue({ id: "role-2", code: "custom", name: "自定义" });
  ...
  describe("PUT /api/admin/roles/:id", () => {
    it("should update a role", async () => {
      (prisma.role.findUniqueOrThrow as ReturnType<typeof vi.fn>).mockResolvedValue({ id: "role-2", system: false, code: "custom" });
      (prisma.role.update as ReturnType<typeof vi.fn>).mockResolvedValue({ id: "role-2", name: "新名称" });
  ...
  describe("DELETE /api/admin/roles/:id", () => {
    it("should delete a custom role", async () => {
      (prisma.role.findUniqueOrThrow as ReturnType<typeof vi.fn>).mockResolvedValue({ id: "role-2", system: false, _count: { members: 0 } });
      (prisma.role.delete as ReturnType<typeof vi.fn>).mockResolvedValue({ id: "role-2" });
    ...
    it("should reject deleting system role", async () => {
      (prisma.role.findUniqueOrThrow as ReturnType<typeof vi.fn>).mockResolvedValue({ id: "role-1", system: true, _count: { members: 0 } });
  ...
  describe("GET /api/admin/settings", () => {
    it("should return settings", async () => {
      (prisma.systemSetting.findMany as ReturnType<typeof vi.fn>).mockResolvedValue([{ key: "a", value: 1 }]);
  ...
  describe("GET /api/admin/settings/:key", () => {
    it("should return a setting", async () => {
      (prisma.systemSetting.findUnique as ReturnType<typeof vi.fn>).mockResolvedValue({ key: "x", value: 1 });
  ...
  describe("PUT /api/admin/settings/:key", () => {
    it("should upsert a setting", async () => {
      (prisma.systemSetting.upsert as ReturnType<typeof vi.fn>).mockResolvedValue({ key: "x", value: 2 });
